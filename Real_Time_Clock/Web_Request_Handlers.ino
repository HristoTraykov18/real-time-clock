...
void HandleWebInterface() { // Handler for the main interface
  ...
  if (overrideSettings) {
    Serial.print(F("Daylight saving is "));
    Serial.println(server.arg("daylightSaving"));
    Serial.print(F("Control brightness "));
    Serial.println(server.arg("brightnessControl"));
    Serial.print(F("Brightness value "));
    Serial.println(server.arg("brightnessValue"));
    Serial.print(F("Time sync mode: "));
    Serial.println(server.arg("timeSyncMode"));
    Serial.print(F("Time sync type: "));
    Serial.println(server.arg("setTimeWith"));
...
void SendWebpageResponse(const char* webpageResponse) {
  ...
  server.handleClient();
  Serial.println(webpageResponse);
}
